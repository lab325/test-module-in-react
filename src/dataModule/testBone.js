...
axios.defaults.baseURL = 'http://127.0.0.1:8000/test/'
...
function fetch(me, params = null, methods = 'post', thenFun = null, catchFun = null) {
  /** params 为参数，以键值对形式传递
...
export class Model extends ModelMap{
  ...
  fetch(params, url, methods, thenFun, catchFun) {
